...
<html>
	...
	function getBody() {
		...
		$output .= '<div class="information"><ul>'.
			...
			'<li>Parsed '.$this->getFileName().' in '.$this->getTimeToParse().' s</li>'.
	...
	function getFooter() {
		$footer = '
			<div class="footer">
				Report generated by <a href="http://pgfouine.projects.postgresql.org/">pgFouine</a>.
			</div>
		</div>
	</body>
</html>
	...
	function getStyles() {
		$styles = '
			...
			* { font-family: Verdana, Arial, Helvetica; }
			...
			div.menu a:hover { padding-right:3px; padding-left:3px; padding-top:4px; padding-bottom:4px; text-decoration:none; background-color:rgb(180, 80, 80); color:white;}
